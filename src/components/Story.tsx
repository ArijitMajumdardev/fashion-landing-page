    ...
    {/* <div className="relative h-screen w-full bg-neutral-900 text-center text-gray-200 -mt-[10vh]
      ...
      <div className="w-2/5 p-4 mb-2 h-3/6  text-left absolute bottom-20 left-10 flex flex-col justify-center gap-8 font-serif">
        ...
        <p className="leading-7">
          ...
          surrounded by fabric rolls, chalk lines, and the rhythmic hum of sewing machines.
          The roots of Voida trace back to a father who spent his life mastering the art
          of tailoring. He didn’t just stitch clothes — he crafted character.
        </p>
      </div>
    </div>
  );
